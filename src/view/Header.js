...
function Header() {
    ...
    return ( <
        ...
        div className = "flex" >
        <
        button className = "bg-white p-2 rounded-full text-xs md:text-sm px-4 focus:outline-none hover:shadow-2xl hover:text-discord_blue transition duration-200 ease-in-out whitespace-nowrap font-medium"
