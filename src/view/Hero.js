      ...
      <div className="h-screen gap-10 px-6 py-5 w-1/2">
        ...
        <div className="flex">
          <div className=" my-5 space-x-3">
            <button className="bg-white p-2 rounded-full text-s md:text-s px-4  mb-5 focus:outline-non hover:shadow-2xl hover:text-discord_blue hover:bg-black ">{DownloadIcon} Download</button>
